        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4">
                    ...
                    <small id="emailHelp" class="form-text text-muted">Задание завершено: <?php echo $active["update_at"];?></small>
                </ul>

                <form method="post" action="task_back.php">
                    <button type="submit" name="task_back" value="<?php echo $active["id"];?>" class="btn btn-lg btn-block btn-outline-danger">Вернуть задачу</button>
                </form>            </div>
        </div>
    </div>
<?php endforeach; ?>
