<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-dark border-bottom shadow-sm">
    <a href="/" class="my-0 mr-md-auto font-weight-normal text-white text-decoration-none">
        <h5 class="my-0 text-white"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-box-fill" viewBox="0 0 16 16">
